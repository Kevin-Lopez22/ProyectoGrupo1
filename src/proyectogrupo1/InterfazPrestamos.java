...
public class InterfazPrestamos extends javax.swing.JFrame {
    ...
    //INTERFAZ BIBLIOTECA
    GUIBiblioteca biblioteca1;
    public InterfazPrestamos() {
        initComponents();
        biblioteca1 = new GUIBiblioteca();
    ...
    public String calcularMulta(String dayBefore) {
        ...
        int diff = (int) ChronoUnit.DAYS.between(Before, After);
        if (diff <= 0) {
    ...
    private void initComponents() {
        ...
        txtCodigoTexto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCodigoTextoActionPerformed(evt);
            }
        });
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addComponent(btnValidarCancelar)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtInfoCancelar, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(btnCancelar)
    ...
    private void btnValidarCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValidarCancelarActionPerformed
        ...
        if (cedulaCancelar.isEmpty() || codigoCancelar.isEmpty()) {
            ...
            try {
                ...
                String multa = calcularMulta(dayBefore);
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        try {
            ...
            String consulta2 = "update ejemplares set estado = 'disponible' where IDEJEMPLAR = " + codigoCancelar;
            sql.executeUpdate(consulta2);
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        // TODO add your handling code here:
        buscarCedula = txtCedulaCliente.getText();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (verificacionConsulta == 1) {
            try {
                ...
                //Impresion de los datos del prestamo
                txtInformacioModificada.setText("\t¡PRÉSTAMO MODIFICADO!\n"
                        + "Nuevos datos del préstamo: \n"
                        + "     Fecha a entregar el libro :: " + fFinalModificada
                        + "\n El préstamo se modificó de manera exitosa.");
    ...
    private void txtCodigoTextoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCodigoTextoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCodigoTextoActionPerformed
