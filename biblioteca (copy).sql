...
create database baseBibliotecaAux
go

use baseBibliotecaAux
go
...
create table EJEMPLARES (
   ...
   ESTADO         char(50)             not null default 'Disponible',
...
create table PRESTAMO (
   ...
   constraint PK_PRESTAMO primary key nonclustered (IDPRESTAMO)
)
go
...
create table INDICES(
   ...
   lastIdx               int                  not null DEFAULT 0,
)

INSERT INTO INDICES(nombre) VALUES("idCliente");
INSERT INTO INDICES(nombre) VALUES("idPrestamo");
INSERT INTO INDICES(nombre) VALUES("idLibro");
INSERT INTO INDICES(nombre) VALUES("idEjemplar");
go