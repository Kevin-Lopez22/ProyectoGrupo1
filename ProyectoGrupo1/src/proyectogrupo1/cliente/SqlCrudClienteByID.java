...
final public class SqlCrudClienteByID implements SqlCrud<Cliente,String>{

    Connection connection;

    public SqlCrudClienteByID(Connection connection) {
    ...
    public void update(Cliente e) throws SQLException{
        ...
        prepStat.setString(7, String.valueOf(e.getIdCliente()));
