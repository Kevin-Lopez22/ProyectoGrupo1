 ...
 * @author luism
 */
public class SqlCrudLibro implements SqlCrud<Libro,String>{
    Connection connection;

    public SqlCrudLibro(Connection connection) {
    ...
    public void update(Libro e) throws SQLException {
        ...
        prepStat.setString(1, e.getTitulo());
        prepStat.setString(2, e.getISBN());
        prepStat.setString(3, e.getAutor());
        prepStat.setInt(4, e.getStock());
        prepStat.setInt(5, e.getPaginas());
        prepStat.setString(6, e.getIdLibro());
